...
import com.test.bendiollamaqwen3vl4b.service.ChatMemoryServiceImpl版本2;
...
public class ExampleController {
    ...
    private final ChatMemoryServiceImpl版本2 chatMemoryService;
    private final EmbeddingModel embeddingModel;

    public ExampleController(@Qualifier("ollamaChatModel") ChatModel chatModel,
                             ChatMemoryServiceImpl版本2 chatMemoryService, @Qualifier("ollamaEmbeddingModel") EmbeddingModel embeddingModel) {
